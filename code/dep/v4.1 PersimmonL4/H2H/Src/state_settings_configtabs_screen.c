...
void behaviour_settings_configtabs_screen(state_ptr state)
{
  ...
  /* Do state actions */
  menu_settings_configtabs.items[1].item.area.is_active = GUI_INACTIVE;
  menu_settings_configtabs.items[1].item.area.text_color = (color_t) COLOR_BLUE;
  menu_settings_configtabs.items[1].item.area.bg_color = (color_t) COLOR_WHITE;
