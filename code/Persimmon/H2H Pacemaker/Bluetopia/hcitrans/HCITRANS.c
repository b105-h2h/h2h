...
#define HCITR_UART_IRQ USART1_IRQn
...
//  // if i have enough time,do a better check
//
...
//      if(UartContext.SuspendState == hssSuspended)
//      {
//         DisableInterrupts(); // NO GOD, NO
//
////         EnableUartPeriphClock();
////         SetSuspendGPIO(FALSE);
//         __HAL_RCC_USART1_CLK_ENABLE();
//         // gpios should be managed by hw
//           
//         UartContext.SuspendState = hssNormal;
//
//         EnableInterrupts(); // NO GOD, NO 2.0
//      }
// we will debug with the debugger, thank you
//#ifdef HCITR_ENABLE_DEBUG_LOGGING
//
//      if(UartContext.DebugEnabled)
//      {
...
//      }
   ...
   // Maybe i'm missing something, but all that crap is just one function call
